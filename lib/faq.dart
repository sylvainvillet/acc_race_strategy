...
const kFaq = {
  'How to use ACC Strategist':
      'Just fill the form, adjust average lap time and fuel usage if needed, and click Go!\n'
  ...
  'How does it work?': 'The app first calculates a base strategy, without any fuel saving.\n'
      ...
      'The app will then try to reduce again the number of pit stops, until it\'s not valid anymore. There can be up to 6 strategies for 24h races.',
  ...
  'Should I go for the fuel saving strategy?':
      'You can see that the average lap time is different for each strategy. If, for example, the average lap time is 2:00 for the normal strategy and 2:01 for the fuel saving one, '
          'then if you can reach the fuel average needed without loosing more than 1s, go for the fuel saving strategy, otherwise the normal one..',
